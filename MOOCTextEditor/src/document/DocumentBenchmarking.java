				...
				numToCheck += increment)
		{
			 ...
			 */  
			 ...
			 for(int i = 0; i < trials; i++)
			 {
				 ...
				 double fscore = bdoc.getFleschScore();
			 }
			 endTime = System.nanoTime();
			 BasicTime =  (endTime - startTime)/1000000000.0;
			 ...
			 for(int i = 0; i < trials; i++)
			 {
				...
				double fscore = edoc.getFleschScore();
			 }
			 endTime = System.nanoTime();
			 EfficientTime = (endTime - startTime)/1000000000.0;
			System.out.format("%d\t\t%f\t\t%f\n",numToCheck,BasicTime,EfficientTime);
		}
